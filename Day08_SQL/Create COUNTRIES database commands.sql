...
ALTER TABLE COUNTRIES MODIFY COLUMN COUNTRY_CODE VARCHAR(3);
-- insert values
...
CREATE TABLE COUNTRIES.REGIONS(ID INT, NAME VARCHAR(255));

CREATE TABLE COUNTRIES.SUB_REGIONS(ID INT, NAME VARCHAR(255));
INSERT INTO COUNTRIES.SUB_REGIONS VALUES 
